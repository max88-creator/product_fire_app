    ...
    Box(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(64.dp)
                    .background(color = basketItem.bgColor, shape = CircleShape),
                contentAlignment = Alignment.Center
            ) {
                Image(
                    painter = painterResource(id = basketItem.image),
            ...
            Column(
                ...
                Text(
                    text = "$ ${basketItem.coast} x ${basketItem.count}",
                    style = TextStyle(
                ...
                Text(
                    text = "$ ${basketItem.weightValue} ${basketItem.weightParameter}",
                    style = TextStyle(
                        fontFamily = AppFontFamily,
                        color = CustomGray,
                        fontSize = 12.sp,
            ...
            Column(
                ...
                Text(
                    text = basketItem.count.toString()
                )
                Text(
                    text = "-",
                    style = TextStyle(
